...
namespace Proxies\__CG__\LocalisationBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Ville extends \LocalisationBundle\Entity\Ville implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'LocalisationBundle\\Entity\\Ville' . "\0" . 'idville', '' . "\0" . 'LocalisationBundle\\Entity\\Ville' . "\0" . 'codepostal', '' . "\0" . 'LocalisationBundle\\Entity\\Ville' . "\0" . 'nomville', '' . "\0" . 'LocalisationBundle\\Entity\\Ville' . "\0" . 'iddepartement');
        }

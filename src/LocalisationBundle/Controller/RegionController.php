...
use LocalisationBundle\Entity\Region;
use LocalisationBundle\Form\RegionType;
...
class RegionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $regions = $em->getRepository('LocalisationBundle:Region')->findAll();
    ...
    {
        $region = new Region();
        $form = $this->createForm('LocalisationBundle\Form\RegionType', $region);
    ...
    {
        $deleteForm = $this->createDeleteForm($region);
        $editForm = $this->createForm('LocalisationBundle\Form\RegionType', $region);

...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'project', 'user' => 'root', 'password' => 'fb170812', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/LocalisationBundle/Resources/config/doctrine') => 'LocalisationBundle\\Entity', ($this->targetDirs[3].'/src/AnnoncesBundle/Resources/config/doctrine') => 'AnnoncesBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/UserBundle/Entity'))), 'UserBundle\\Entity');
        $c->addDriver($a, 'FOS\\UserBundle\\Entity');
        $c->addDriver($b, 'LocalisationBundle\\Entity');
        $c->addDriver($b, 'AnnoncesBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('UserBundle' => 'UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'LocalisationBundle' => 'LocalisationBundle\\Entity', 'AnnoncesBundle' => 'AnnoncesBundle\\Entity'));
...
<<<<<<< HEAD
        $instance->setNamespace('sf2orm_default_ac3b4048d713fb89f7772f9784f8b3cafc6c014463f525db92a56b4d8816375e');
=======
        $instance->setNamespace('sf2orm_default_30d65aa4d64c5c70db8650ebf6e0fdfe585c80de70a6b10743f0e7b1325d3121');
>>>>>>> 720bb39329552ad4aa46eebe17fa322ce2c60155
...
>>>>>>> 720bb39329552ad4aa46eebe17fa322ce2c60155
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/annonce/new');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/annonce/mesAnnonces');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/categorie');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ville');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/region');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/departement');
...
>>>>>>> 720bb39329552ad4aa46eebe17fa322ce2c60155
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/LocalisationBundle/Resources/views'), 'Localisation');
        $instance->addPath(($this->targetDirs[3].'/src/AnnoncesBundle/Resources/views'), 'Annonces');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LocalisationBundle' => 'LocalisationBundle\\LocalisationBundle',
                'AnnoncesBundle' => 'AnnoncesBundle\\AnnoncesBundle',
